...
const navLinks = [
  ...
  { name: 'Diagnostics', href: '/diagnostics', public: true },
  { name: 'Checkups', href: '/checkups', public: true },
  { name: 'Prescription', href: '/prescription', public: true },
  { name: 'Complaints', href: '/complaints', public: true },
